...
def share_instances_get_all_by_share_group_id(context, group_id):
    ...
    return IMPL.share_instances_get_all_by_share_group_id(context, group_id)
...
def share_get_all_by_share_group_id(context, group_id,
                                    filters=None, sort_key=None,
                                    sort_dir=None):
    """Returns all shares with given project ID and group id."""
    return IMPL.share_get_all_by_share_group_id(
        context, group_id, filters=filters,
        sort_key=sort_key, sort_dir=sort_dir)
...
def share_group_get_all(context, detailed=True, filters=None, sort_key=None,
    ...
    return IMPL.share_group_get_all(context, detailed=detailed,
...
def share_group_get_all_by_host(context, host, detailed=True, filters=None,
    ...
    return IMPL.share_group_get_all_by_host(context, host, detailed=detailed,
                                            filters=filters, sort_key=sort_key,
                                            sort_dir=sort_dir)
...
def count_shares_in_share_group(context, share_group_id):
    ...
    return IMPL.count_shares_in_share_group(context,
                                            share_group_id)


def count_group_snapshots_in_share_group(context, share_group_id):
    """Returns the number of group_snapshots with the specified group."""
    return IMPL.count_group_snapshots_in_share_group(context,
                                                     share_group_id)
...
def count_group_snapshot_members_in_share(context, share_id, session=None):
    ...
    return IMPL.count_group_snapshot_members_in_share(context, share_id)
...
def group_snapshot_get_all(context, detailed=True, filters=None, sort_key=None,
    ...
    return IMPL.group_snapshot_get_all(context, detailed=detailed,
                                       filters=filters, sort_key=sort_key,
                                       sort_dir=sort_dir)
...
def group_snapshot_get_all_by_project(context, project_id, detailed=True,
    ...
    return IMPL.group_snapshot_get_all_by_project(
        context, project_id, detailed=detailed, filters=filters,
        sort_key=sort_key, sort_dir=sort_dir)
...
def group_snapshot_destroy(context, group_snapshot_id):
    """Destroy the group_snapshot or raise if it does not exist."""
    return IMPL.group_snapshot_destroy(context, group_snapshot_id)


def group_snapshot_members_get_all(context, group_snapshot_id):
    """Return the members of a group snapshot."""
    return IMPL.group_snapshot_members_get_all(context, group_snapshot_id)


def group_snapshot_member_create(context, values):
    """Create a group snapshot member from the values dictionary."""
    return IMPL.group_snapshot_member_create(context, values)


def group_snapshot_member_update(context, member_id, values):
    """Set the given properties on a group snapshot member and update it.

    Raises NotFound if group_snapshot member does not exist.
    """
    return IMPL.group_snapshot_member_update(context, member_id, values)
...
def group_type_get_all(context, inactive=False, filters=None):
    ...
    :returns: list of matching group types
    """
    return IMPL.group_type_get_all(context, inactive, filters)


def group_type_get(context, type_id, inactive=False, expected_fields=None):
    ...
    :returns: group type
    """
    return IMPL.group_type_get(context, type_id, inactive, expected_fields)
...
def group_type_extra_specs_get(context, group_type_id):
    """Get all extra specs for a group type."""
    return IMPL.group_type_extra_specs_get(context, group_type_id)


def group_type_extra_specs_delete(context, group_type_id, key):
    """Delete the given extra specs item."""
    return IMPL.group_type_extra_specs_delete(context, group_type_id, key)


def group_type_extra_specs_update_or_create(context, group_type_id,
                                            extra_specs):
    """Create or update group type extra specs.

    This adds or modifies the key/value pairs specified in the extra
    specs dict argument.
    """
    return IMPL.group_type_extra_specs_update_or_create(context,
                                                        group_type_id,
                                                        extra_specs)
