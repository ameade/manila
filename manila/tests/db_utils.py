...
def create_share_group(**kwargs):
    ...
    return _create_db_row(db.share_group_create, group, kwargs)


def create_group_snapshot(group_id, **kwargs):
    ...
    return _create_db_row(db.group_snapshot_create, snapshot, kwargs)


def create_group_snapshot_member(group_snapshot_id, **kwargs):
    """Create a group_snapshot member object."""
    member = {
        'share_proto': "NFS",
        'size': 0,
        'share_id': None,
    ...
    return _create_db_row(db.group_snapshot_member_create, member, kwargs)
